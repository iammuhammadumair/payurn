...
@push('css')
<link rel="stylesheet" href="{{ asset('admin_assets/plugins/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css') }}"/>
@endpush
...
@push('script')
<script src="{{ asset('admin_assets/plugins/bootstrap/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('admin_assets/plugins/bootstrap/jquery-menu-editor.min.js') }}"></script>
<script src="{{ asset('admin_assets/plugins/bootstrap-iconpicker/js/iconset/fontawesome5-3-1.min.js') }}"></script>
<script src="{{ asset('admin_assets/plugins/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js') }}"></script>
<script src="{{ asset('admin_assets/plugins/bootstrap-iconpicker/js/menu.js') }}"></script>
@endpush
