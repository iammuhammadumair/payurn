...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('admin_assets/assets/css/summernote/summernote-bs4.css') }}">
@endsection
...
@push('script')
    ...
    <script src="{{ asset('admin_assets/plugins/dropzone/components-multiple-upload.js') }}"></script>
    <script src="{{ asset('admin_assets/custom/media.js') }}"></script>
    <script src="{{ asset('admin_assets/assets/js/summernote-bs4.js') }}"></script>
    <script src="{{ asset('admin_assets/assets/js/summernote.js') }}"></script>
