            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-product-area text-center">
                        ...
                        <div class="product-img">
                            <img src="{{ asset('frontend_assets/img/bg-img/p-1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-product-area text-center">
                        <!-- product img -->
                        <div class="product-img">
                            <img src="{{ asset('frontend_assets/img/bg-img/p-2.jpg') }}" alt="">
                        </div>
                        <span class="product-badge">New</span>
                        <div class="product-compare">
                            <a href="#"><i class="fas fa-exchange-alt"></i></a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-product-area text-center">
                        <!-- product img -->
                        <div class="product-img">
                            <img src="{{ asset('frontend_assets/img/bg-img/p-3.jpg') }}" alt="">
                        </div>
