...
@push('css')
    <link rel="stylesheet" href="{{ asset('admin_assets/plugins/chocolat/dist/css/chocolat.css') }}">
@endpush

@push('script')
    <script src="{{ asset('admin_assets/plugins/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>
@endpush
